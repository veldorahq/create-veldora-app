...
@section('content')
    ...
    <div class="post-card">
        <div class="post-header">
            ...
            <span>Latest seeded post (DB query):</span>
        </div>
        <h3>{{ $postTitle }}</h3>
        <p class="post-body">{{ $postBody }}</p>
    </div>

    <!-- Test of Custom Components with Slots -->
    <div style="margin-bottom: 2rem; display: flex; align-items: center; gap: 8px;">
        <span style="font-size: 0.75rem; color: #666;">Framework status:</span>
        <x-badge type="success">Phase 2 Completed</x-badge>
    </div>
